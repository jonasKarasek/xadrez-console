...
namespace xadrez
{
    class Rei : Peca
    {
        ...
        public Rei(Tabuleiro tab, Cor cor, PartidaDeXadrez partida) : base(tab, cor)//construtor
        {
        ...
        public override bool[,] movimentosPossiveis()//retorna matriz xadrez com as posições para que este tipo de peça pode se mover
        {
            ...
            {
                Posicao pTorre1 = new Posicao(posicao.linha, posicao.coluna + 3);
            ...
            if (qteMovimentos == 0 && !partida.xeque)
            {
                Posicao pTorre1 = new Posicao(posicao.linha, posicao.coluna - 4);
                if (testeTorreParaRoque(pTorre1))
                {
                    Posicao p1 = new Posicao(posicao.linha, posicao.coluna - 1);
                    Posicao p2 = new Posicao(posicao.linha, posicao.coluna - 2);
